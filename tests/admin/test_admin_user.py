...
def test_admin_get_users(client, admin_access_token):
...
def test_admin_create_user(client, admin_access_token):
...
def test_admin_get_user_detail(client, admin_access_token):
    headers = {"Authorization": f"Bearer {admin_access_token}"}
...
def test_admin_get_user_detail_not_found(client, admin_access_token):
    headers = {"Authorization": f"Bearer {admin_access_token}"}
...
def test_admin_update_user_success(client, admin_access_token):
    update_data = {
...
def test_admin_update_user_not_found(client, admin_access_token):
    headers = {"Authorization": f"Bearer {admin_access_token}"}
...
def test_admin_update_user_empty_json(client, admin_access_token):
    headers = {
...
def test_admin_delete_user_success(client, admin_access_token):
    headers = {"Authorization": f"Bearer {admin_access_token}"}
